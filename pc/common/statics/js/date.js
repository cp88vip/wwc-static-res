...
function getSevendayDate() {
	var sevenday = new Date(now.getTime() - oneDay * 6);
	return formatDate(sevenday)
}
function getThirtyDate() {
	var thirtyday = new Date(now.getTime() - oneDay * 29);
	return formatDate(thirtyday)
}
//获得某月的天数
