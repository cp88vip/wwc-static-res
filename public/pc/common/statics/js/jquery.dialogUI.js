...
(function(g) {
    ...
    g.alert =g.alert1 = function(v, u, t, r, o, q) {
        ...
        g("#JS_blockPage").easydrag();
        g("#JS_blockPage").setHandler("block_draghandler")
    };
    g.confirm = function(q, w, x, v, o, u, t, p) {
        ...
        var r = m({
            ...
            ismsgcenter: u,
            bt_html: t,
            bt_text: '<input type="button" value="&nbsp;&nbsp;' + g.blockUI_lang.button_sure + '&nbsp;&nbsp;" id="confirm_yes" style="margin-right:15px;" class="yh" /><input type="button" value="' + g.blockUI_lang.button_cancel + '" id="confirm_no" class="yh" />'
        });
        $html = g(r);
        if (p == window) {
            g.blockUI({
            ...
            if (w || A == "timeout") {
                ...
                try {
                    ...
                    if (B != "error") {
                        ...
                        g("#block_ajaxConfirm").val(g.blockUI_lang.button_uploadend).prop("disabled", false).off("click").click(function() {
                            g.unblockUI({
                                fadeOutTime: 0,
                                onUnblock: p.onfinish
                            })
                        });
                        g("#block_close", $html).off("click").click(function() {
                            g.unblockUI({
                                fadeOutTime: 0,
                                onUnblock: p.onfinish
                            })
    ...
    function m(p) {
        ...
        var o = '<div class=mdl style="width:' + p.width + 'px;"><h3 id="block_draghandler">' + p.title + '</h3><table style="width:100%;"><tr><td ' + (p.ismsgcenter ? 'style="text-align:center;"': "") + ">" + p.msg + "</td></tr>";
        if (p.isbottom) {
            if (p.bt_html.length > 10) {
                o += '<tr><td><table><tr><td style="padding-top:4px;">' + p.bt_html + '</td><td style="text-align:right;float:right;">' + p.bt_text + "</td></tr></table></td></tr></table>"
            } else {
        ...
        o += '<div class=mdl_t_l></div><div class=mdl_t_c id="block_draghandlerx"><span></span></div><div class=mdl_t_r></div><div class=mdl_c_l><span></span></div><div class=mdl_c_r><span></span></div><div class=mdl_b_l></div><div class=mdl_b_c><span></span></div><div class=mdl_b_r></div><div class=mdl_clo><img src="/pc/common/statics/img/lottery/t.gif" class=c1 id="block_close" style="cursor:pointer;"></div>';
        return o;
    }
    g.blockUI.defaults = {
    ...
    var c = (!h || h < 8);
    var d = /MSIE 6.0/.test(navigator.userAgent) && !h;
    ...
    function e(o, A) {
        ...
        var I = "display:none;padding:0;margin:0;left:35%;text-align:center;color:#000000;border:0px;";
        var H = g('<div id="JS_blockUI" style="z-index:' + (v++) + ";" + x + '"></div>');
    ...
    function l(o) {
        $(".datainfo2").css({height:g(window).height()/2});
